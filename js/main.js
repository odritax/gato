...
var cuadrados= document.querySelectorAll('.cuadrados');
  ...
  function reset(){
    cuadrados.forEach(function (cuadrado) {
      cuadrado.innerHTML='&nbsp';
      cuadrado.classList.remove('bloqueo');
      turno.innerHTML='X';
      cuadrado.classList.remove('ganadora');
    });
  }
  ...
  function no_te_metas_en_mis_asuntoz(){
    cuadrados.forEach(function (cuadrado) {
      cuadrado.classList.add('bloqueo');
    });
    setTimeout($('#modal').modal('show'), 3000);///lo unico que te falta pasar odrita animooo ●︿●
    setTimeout(reset, 3000);
  }

  function x_puntaje(){
      var puntaje_x=document.querySelector('#puntaje_x').innerHTML;
  ...
  function y_puntaje(){
    var puntaje_y=document.querySelector('#puntaje_y').innerHTML;
  ...
  {
    document.querySelector('#puntaje_x').innerHTML=localStorage.getItem('valorx');
  }
    //--->O
  ...
  {
    document.querySelector('#puntaje_y').innerHTML=localStorage.getItem('valoro');
  }
